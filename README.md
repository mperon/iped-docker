# IPED Container for ARM Processors

The source was forked from [iped-docker/iped](https://github.com/iped-docker) repository.

We plan in the future that this image supports both arm64 and x86 processors.

PS: Only the processor is working.
...
sudo docker run --rm -it -v /mnt/evidences:/evidences \
                 ...
                 -v /mnt/hashesdb:/mnt/hashesdb \
                   mperon/iped-processor java -jar iped.jar --nogui \
...
```
sudo docker run --rm -it mperon/iped-processor java -jar iped.jar --help
```
...
1. Clone the repository
    ...
    ```
    git clone https://github.com/mperon/iped-docker
    cd iped-docker
    ```
...
```
    sudo dkr -v /mnt/evidences:/evidences \
                   ...
                   -v /mnt/plugins:/mnt/plugins \            
                   -v /mnt/hashesdb:/mnt/hashesdb \
                   mperon/iped-processor java -jar iped.jar \
                   -d /evidences/test/test.dd \
                   -o /evidences/test/iped-output
```
